...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<actionmailer>.freeze, ["< 7", ">= 3.2.6"])
      s.add_runtime_dependency(%q<actionpack>.freeze, ["< 7", ">= 3.2.6"])
      s.add_runtime_dependency(%q<devise>.freeze, ["< 6", ">= 3.2"])
      s.add_development_dependency(%q<rspec>.freeze, ["~> 3.0"])
      s.add_development_dependency(%q<inch>.freeze, ["~> 0.4"])
      s.add_development_dependency(%q<activerecord>.freeze, ["< 7", ">= 3.2.6"])
      s.add_development_dependency(%q<mongoid>.freeze, ["< 8", ">= 3.1.0"])
      s.add_development_dependency(%q<appraisal>.freeze, ["~> 2.0"])
    else
      s.add_dependency(%q<actionmailer>.freeze, ["< 7", ">= 3.2.6"])
      s.add_dependency(%q<actionpack>.freeze, ["< 7", ">= 3.2.6"])
      s.add_dependency(%q<devise>.freeze, ["< 6", ">= 3.2"])
      s.add_dependency(%q<rspec>.freeze, ["~> 3.0"])
      s.add_dependency(%q<inch>.freeze, ["~> 0.4"])
      s.add_dependency(%q<activerecord>.freeze, ["< 7", ">= 3.2.6"])
      s.add_dependency(%q<mongoid>.freeze, ["< 8", ">= 3.1.0"])
